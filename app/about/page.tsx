  ...
  return (
    <div className='bg-white'>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/mujer-joven-ensenando-ninos-clase-ingles-linea_23-2148962943.jpg')"
        }}
      >
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl sm:text-2xl text-charcoal mb-8 leading-relaxed max-w-3xl mx-auto'>
              ...
              <span className='text-pastel-red font-semibold'>
                Acompañarte a dominarlo, nuestra misión.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className='py-8 lg:py-8 bg-white'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-6xl mx-auto'>
            <h2 className='text-3xl lg:text-4xl font-bold text-charcoal-dark mb-8 text-center'>
              Nuestra historia
            </h2>
            <div className='grid md:grid-cols-2 gap-12 items-center'>
              <div className='prose prose-lg max-w-none text-charcoal leading-relaxed'>
                <p className='text-lg mb-4'>
                  Alexandria Language nació con un propósito claro: acercar el
                  inglés a personas reales, con métodos actuales, docentes
                  apasionados y un ambiente acogedor.
                </p>
                <p className='text-lg mb-4'>
                  Fundada en 2023, nuestra escuela se ha convertido en un
                  espacio donde aprender inglés no solo es efectivo, sino
                  también inspirador. Creemos que cada estudiante tiene un
                  potencial único, y nuestro trabajo es ayudarle a descubrirlo y
                  desarrollarlo.
                </p>
                <p className='text-lg'>
                  A lo largo de estos años, hemos acompañado a cientos de
                  estudiantes en su viaje hacia el dominio del inglés, viendo
                  cómo transforman no solo su nivel del idioma, sino también su
                  confianza y sus oportunidades profesionales.
                </p>
              </div>
              <Card className='bg-rose-light/50 border-rose-100 shadow-lg relative h-full flex items-center justify-center aspect-square rounded-3xl max-w-sm mx-auto'>
                <CardContent className='p-0 flex items-center justify-center h-full w-full'>
                  <img
                    src='/auriculares-libros-texto-ingles-primer-plano-teclado-ordenador-portatil_151013-59824.jpg'
                    alt='Auriculares sobre libros y teclado portátil - Alexandria Language School'
                    className='object-cover w-full h-full'
                  />
                </CardContent>

                <div className='absolute bottom-[-20px] right-[-20px] bg-white px-6 py-4 rounded-lg shadow-md text-center'>
                  <p className='text-2xl font-bold text-pastel-red'>2023</p>
      ...
      {/* Misión y Visión */}
      <section className='py-8 lg:py-8 bg-gradient-to-b from-white to-rose-light/20'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid lg:grid-cols-2 gap-12'>
              ...
              <Card className='bg-white shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform-gpu'>
                <CardContent className='px-6 py-10 text-center'>
                  ...
                  <p className='text-gray-700 text-base leading-relaxed max-w-md mx-auto'>
                    Nuestra misión es empoderar a jóvenes y adultos a través del
                    dominio del inglés, con una enseñanza cercana, personalizada
              ...
              <Card className='bg-white shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform-gpu'>
                <CardContent className='px-6 py-10 text-center'>
                  ...
                  <p className='text-gray-700 text-base leading-relaxed max-w-md mx-auto'>
                    Queremos ser un referente en la enseñanza del inglés en
                    España, ofreciendo calidad, innovación y resultados reales
                    en cada clase.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-8'>
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Clases enfocadas en la comunicación práctica y situaciones
                    de la vida real.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Docentes con certificación internacional y experiencia
                    comprobada.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Recursos actualizados y tecnología educativa de vanguardia.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Monitoreo individual del progreso y adaptación a tu ritmo.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Ambiente cercano y sin miedo a equivocarse, donde todos
                    aprenden.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1'>
                <CardContent className='p-6 text-center'>
                  ...
                  <p className='text-charcoal'>
                    Máximo 8 estudiantes por clase para atención personalizada.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className='py-8 lg:py-8 bg-rose-light/30'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-4xl mx-auto flex justify-center'>
            <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300 w-full max-w-md'>
              <CardContent className='p-8 text-center'>
                <div className='w-28 h-28 bg-pastel-red/10 rounded-full mx-auto mb-6 flex items-center justify-center'>
                  <img
                    src='/placeholder.svg?height=112&width=112'
                    alt='Alexandra Elkzzaz - Coordinadora académica'
                    className='w-24 h-24 rounded-full object-cover'
                  />
                </div>
                <h3 className='text-2xl font-semibold text-charcoal-dark mb-3'>
                  Alexandra Elkzzaz
                </h3>
                <p className='text-pastel-red font-medium mb-4 text-lg'>
                  Coordinadora Académica
                </p>
                <p className='text-charcoal italic text-base leading-relaxed'>
                  "Creo en una enseñanza que transforma vidas y abre puertas al
                  mundo."
                </p>
              </CardContent>
            </Card>
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-3xl mx-auto text-center'>
            <h2 className='text-3xl lg:text-4xl font-bold text-white mb-4'>
              Ahora que nos conoces, ¿estás listo para{' '}
              <span className='text-pastel-red'>dar el paso</span>?
            </h2>
            <p className='text-gray-300 text-lg mb-8 leading-relaxed'>
              Descubre nuestros programas y comienza tu viaje hacia el dominio
              del inglés.
            </p>
            <Button
              size='lg'
