  ...
  return (
    <div className='bg-white'>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('/grupo-companeros-clase-sentados-escritorio-mirando-tableta-discutiendo-algo-camara-enfocada-bandera-britanica_280538-3074.jpg')"
        }}
      >
        {/* Overlay para oscurecer y que el texto se lea mejor */}
        <div className='absolute inset-0 bg-gradient-to-br from-rose-light/80 via-white/80 to-rose-light/60'></div>

        <div className='relative container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-4xl mx-auto text-center'>
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-bold text-charcoal-dark mb-6 leading-tight'>
              Aprende inglés.{' '}
              <span className='text-pastel-red'>Mejora tu futuro.</span>
            </h1>
            <p className='text-xl sm:text-2xl text-charcoal mb-8 leading-relaxed max-w-3xl mx-auto'>
              Clases presenciales y online con profesores certificados y un
              enfoque práctico. En Alexandria Language, el inglés se aprende de
              verdad.
            </p>
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='max-w-3xl mx-auto text-center'>
            ...
            <p className='text-lg text-charcoal mb-8 leading-relaxed'>
              Somos una escuela de idiomas moderna especializada en la enseñanza
              del inglés con un enfoque cercano, dinámico y orientado a
              resultados.
            </p>
            <Button
              variant='outline'
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-500 text-lg mt-2'>
              Programas estructurados para todos los niveles, desde principiante
              hasta avanzado.
            </p>
          </div>
            ...
            <div className='bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border-t-4 border-green-400 relative'>
              <div className='p-6'>
                ...
                <p className='text-charcoal text-sm mb-6 leading-relaxed'>
                  Ideal para quienes empiezan desde cero. Aprende las bases del
                  inglés de forma sólida y divertida.
                </p>
          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 max-w-6xl mx-auto'>
            <div className='text-center group'>
              ...
              <p className='text-sm text-charcoal'>
                Flexibilidad total para adaptarnos a tu horario
              </p>
            </div>
            ...
            <div className='text-center group'>
              ...
              <p className='text-sm text-charcoal'>
                Docentes nativos y bilingües con experiencia
              </p>
            </div>
            ...
            <div className='text-center group'>
              ...
              <p className='text-sm text-charcoal'>
                Máximo 8 estudiantes por clase para mayor atención
              </p>
            </div>
            ...
            <div className='text-center group'>
              ...
              <p className='text-sm text-charcoal'>
                Recursos modernos y tecnología educativa
              </p>
            </div>
      ...
      <section className='py-8 lg:py-8 bg-rose-light/30'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-500 text-lg mt-2'>
              Historias reales de estudiantes que han transformado su futuro con
              nosotros
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-5xl mx-auto'>
            <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-charcoal mb-4 italic'>
                  "En 6 meses logré el nivel que necesitaba para mi trabajo. Los
                  profesores son excelentes y las clases muy dinámicas."
                </p>
            ...
            <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-charcoal mb-4 italic'>
                  "Alexandria me ayudó a conseguir la beca para estudiar en el
                  extranjero. El enfoque práctico marca la diferencia."
                </p>
                <div className='border-t border-rose-100 pt-4'>
                  <p className='font-semibold text-charcoal-dark'>
                    Carlos Ruiz
            ...
            <Card className='bg-white border-rose-100 hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-6 text-center'>
                ...
                <p className='text-charcoal mb-4 italic'>
                  "Después de años intentando aprender inglés, aquí finalmente
                  lo conseguí. El ambiente es muy motivador."
                </p>
                <div className='border-t border-rose-100 pt-4'>
        ...
        <div className='container mx-auto'>
          <div className='max-w-3xl mx-auto text-center'>
            <h2 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4'>
              Tu nivel de inglés puede{' '}
              <span className='text-[#d46a6a]'>cambiar tu vida.</span>
            </h2>
            <p className='text-gray-300 text-lg mb-8 leading-relaxed'>
              Descubre todo lo que puedes lograr con el dominio del inglés. Tu
              futuro profesional y personal te está esperando.
            </p>
            <Button
              size='lg'
